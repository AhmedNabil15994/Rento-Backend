                                ...
                                <div class="account-card alert fade show">
                                    ...
                                    <ul class="account-card-text">
                                        ...
                                        <button type="button" class="btn btn-success "  data-toggle="modal" data-target="#category">
                                            @lang("user::frontend.create_ads.choose")
                                        </button>
                                        <span class="text-success" id="categrory_text"></span>
...
<script>
    $(function(){
        ...
        // handle category 
         ...
         handleSelectCategory($(".select-category"))  
        ...
        $('#jstree').on("changed.jstree", function(e, data) {
                ...
                $("#category").modal('hide')
                var selected = $("#jstree").jstree(true).get_selected('full',true)[0]
                if(selected && selected.data.title)
                   $("#categrory_text").text(selected.data.title)
                else $("#categrory_text").text("")
