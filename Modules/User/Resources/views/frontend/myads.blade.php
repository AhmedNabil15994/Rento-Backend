                ...
                <div class="product-card">
                    <div class="product-media">
                        <div class="product-img">
                            <img class="custom-img-cover custom-img-product" height="200" src="{{$ad->getFirstMediaUrl('default_image') ?  $ad->getFirstMediaUrl('default_image') : url('/uploads/default.png')}}"  alt="product">
                        </div>
