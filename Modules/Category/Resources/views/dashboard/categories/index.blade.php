        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('dashboard.categories.deletes')) }}')">
...
@section('scripts')
  ...
  <script>
   function tableGenerate(data='') {
      var protectedCategory = @json(setting('protectd_cat') ?? []);
