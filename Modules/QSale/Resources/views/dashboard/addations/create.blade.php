...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.addations.store')}}">
                @csrf
                <div class="col-md-12">
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="general">
                                <h3 class="page-title">{{ __('qsale::dashboard.addations.form.tabs.general') }}</h3>
                                <div class="col-md-10">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" name="type">
                                                ...
                                                @foreach (Modules\QSale\Enum\AddationType::getConstList() as $type )
                                                    <option value="{{$type}}">  {{ __('qsale::dashboard.addations.form.types.'.$type) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-actions">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{url(route('dashboard.addations.index')) }}" class="btn btn-lg red">
