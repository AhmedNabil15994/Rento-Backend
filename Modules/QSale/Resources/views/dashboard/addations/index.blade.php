        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('dashboard.addations.deletes')) }}')">
      			...
      			},
            {
              ...
              render: function(data, type, full, meta) {
                ...
                // Edit
      					...
      					return `
                @permission('edit_addations')
      						<a href="`+editUrl+`" class="btn btn-sm blue" title="Edit">
      			              <i class="fa fa-edit"></i>
      			            </a>
      					@endpermission

                @permission('delete_addations')
                @csrf
